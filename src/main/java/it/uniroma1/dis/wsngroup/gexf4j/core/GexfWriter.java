...
public interface GexfWriter {
     ...
     * @throws IOException
     */
    void writeToStream(Gexf gexf, Writer out, String fileName, String encoding) throws IOException;
     ...
     * @throws IOException
     */
    void writeToStream(Gexf gexf, OutputStream out, String fileName, String encoding) throws IOException;
}