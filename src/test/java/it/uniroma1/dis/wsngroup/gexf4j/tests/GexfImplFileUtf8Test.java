...
public class GexfImplFileUtf8Test {
    ...
    public void testStaticGexfGraph() throws IOException, SAXException {
        ...
        graphWriter.writeToStream(gexf, new FileWriter("target/testStaticUtf.gexf"), "test.gexf", "UTF-8");
        graphWriter.writeToStream(gexf, stringWriter,"test.gexf",  "UTF-8");
...
//        myDiff.overrideElementQualifier(new ElementNameAndTextQualifier());
    ...
    public void testStaticGexfGraphStreams() throws IOException, SAXException {
        ...
        graphWriter.writeToStream(gexf, new FileOutputStream("target/testStaticUtf2.gexf"), "test.gexf", "UTF-8");
        graphWriter.writeToStream(gexf, stringWriter, "test.gexf", "UTF-8");
